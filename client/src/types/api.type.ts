...
export type CreatePagePayloadType = {
  workspaceId: string;
  data: {
    title?: string;
    content?: string;
...
export type EditPagePayloadType = {
  workspaceId: string;
  pageId: string;
  data: {
    title?: string;
...
export type PageByIdPayloadType = {
  workspaceId: string;
  pageId: string;
};
...
export type AllPagePayloadType = {
  workspaceId: string;
  pageNumber?: number;
  pageSize?: number;
  skip?: boolean;
...
export type AllPageResponseType = {
  message: string;
  pages: PageType[];
  pagination: PaginationType;
};
